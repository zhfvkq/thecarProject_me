...
<script type="text/javascript"
	src="/resources/include/js/jquery.timepicker.min.js"></script>
<!-- jquery 중복 방지 -->
<script>
	var jb = jQuery.noConflict();
</script>
<link rel="stylesheet" type="text/css"
	href="/resources/include/css/jquery.timepicker.css" />
...
<body>
	<form id="search" class="form-horizontal">
			...
			<input type="hidden" id="url" name="url" value="/product/midproductSelectList">
						...
						<c:forEach var="list" items="${list}">
							...
							<li class="n" data-num="${list.c_num}">
								<div class="border">
									...
									<br>
									<div class="box">
										<h3 class="carName">${list.c_name }</h3>
										<h4>이용료 <fmt:formatNumber value="${list.c_rentalrate}" type="number"/>원</h4>
										<%-- <a
										...
										<div class="Btn1">
											<input type="button" value="상세보기" id="productBtn" class="productBtn btn btn-primary" />
										</div>
									</div>
								</div>
							</li>
