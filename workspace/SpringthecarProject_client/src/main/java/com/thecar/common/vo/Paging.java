...
public class Paging {
	...
	private MyReservationVO myReservationVo;
	...
	public MyReservationVO getReservationVo() {
		return myReservationVo;
	}

	public void setReservationVo(MyReservationVO myReservationVo) {
		this.myReservationVo = myReservationVo;
	}
