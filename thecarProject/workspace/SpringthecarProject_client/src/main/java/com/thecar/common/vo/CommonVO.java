...
public class CommonVO {
	...
	public CommonVO(String search, String keyword, String order_by, String order_sc, String start_date, String end_date,
			String page, String pageSize, String start_row, String end_row) {
		super();
		this.search = search;
