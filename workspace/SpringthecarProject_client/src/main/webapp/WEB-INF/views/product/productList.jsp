...
<body>
	<form id="search" class="form-horizontal">
			...
			<input type="hidden" id="url" name="url" value="/product/productSelectList">
					...
					<ul>
						<c:forEach var="list" items="${list}">
							<li class="n" data-num="${list.c_num}">
								<div class="border">
									<input type="image" src="/resources/images/thecar/${list.c_name}.jpg" class="image">
									<br>
									<div class="box">
										<h3 class="car-name">${list.c_name }</h3>
